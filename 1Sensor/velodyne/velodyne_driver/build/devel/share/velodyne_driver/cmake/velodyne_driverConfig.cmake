...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/build/devel)
...
if(NOT "/program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/build/devel/include;/program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/build/devel/include;/program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /program/ugv_ws/src/ugv_master/1Sensor/velodyne/velodyne_driver/build/devel/lib;/program/ugv_ws/devel/lib;/opt/ros/kinetic/lib)
