...
int main(int argc, char **argv)
{
  ...
  ros::Publisher point_cloud_pub = nh.advertise<sensor_msgs::PointCloud2>("/lms_cloud",100,false);
  n.param<std::string>("host", host, "192.168.2.215");
  ...
  while (ros::ok())
  {
    ...
    while (ros::ok())
    {
      ...
      if (laser.getScanData(&data))
      {
        ...
        ROS_DEBUG("Publishing scan data and cloud data.");
